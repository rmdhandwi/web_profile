      ...
      <div class="row mt-5">
        <div class="col-md-8">
          <div class="card" style="margin-bottom: 20px;">
            <img src="<?= base_url('assets/upload/image/berita/' . $berita['gambar']) ?>" class="img-thumbnail">
            <div class="card-body">
              ...
              <?php foreach ($sidebar as $sidebar) { ?>
                <div class="row">
                  <div class="col-3">
                    ...
                    <?php } else { ?>
                      <img src="<?= base_url('assets/upload/image/berita/' . $sidebar['gambar']) ?>" class="img img-thumbnail">
                    <?php } ?>
                  </div>
                  <div class="col-9">
